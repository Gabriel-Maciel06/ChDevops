...
# 4. Aguardar cloud-init finalizar a instalação do Docker
echo "[4/5] Aguardando cloud-init concluir instalação do Docker (pode levar até 3 min)..."
...
echo "Para conectar na VM, use:"
echo "  ssh $ADMIN_USER@$PUBLIC_IP"
echo "  ou (porta alternativa):"
echo "  ssh -p 443 $ADMIN_USER@$PUBLIC_IP"
echo "========================================="
